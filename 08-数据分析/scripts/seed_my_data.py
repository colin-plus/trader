#!/usr/bin/env python3
"""导入"我的"数据种子：交易记录 + 当前持仓（华亚已清仓 08-27；当前持仓：成都银行/快克智能）。
...
TRANSACTIONS = [
    ...
    (9,  "601838", "2026-08-26", "buy",  18.75, 1200, 22500.00, 5.86, "建底仓，后续持续做T"),
    # 华亚智能（003043）清仓：80.63 × 100 股，费用 9.03
    (10, "003043", "2026-08-27", "sell", 80.63, 100, 8063.00, 9.03, "清仓：卖完最后 100 股"),
    (11, "603203", "2026-08-28", "buy",  44.46, 400, 17784.00, 5.18, "建底仓笔1：44.46×4手"),
    (12, "603203", "2026-08-28", "buy",  44.01, 400, 17604.00, 5.18, "建底仓笔2：44.01×4手（回落补仓摊薄）"),
]

# 当前持仓（券商口径）
POSITIONS = [
    ("601838", 1200, 18.769),         # 成都银行：12 手，券商成本价 18.769（含全部费用）
    ("603203", 800, 44.283),          # 快克智能：8 手，券商成本价 44.283（含全部费用，08-28 建仓）
]
